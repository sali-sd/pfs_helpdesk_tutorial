...
An installation script and full documentation are available in the **[PFS-LAM1D-Installation](https://github.com/sali-sd/pfs_helpdesk_tutorial/tree/main/PFS-LAM1D-Installation)** folder of this repository.
...
Download the installation script from the [PFS-LAM1D-Installation](https://github.com/sali-sd/pfs_helpdesk_tutorial/tree/main/PFS-LAM1D-Installation) folder of this repository:

```bash
curl -O https://raw.githubusercontent.com/sali-sd/pfs_helpdesk_tutorial/main/PFS-LAM1D-Installation/install_lam1d_pipeline.sh
```
